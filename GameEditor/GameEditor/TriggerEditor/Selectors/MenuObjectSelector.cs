...
{
    class MenuObjectSelector : ListSelector
    {
        public string MenuObjectName;
        ...
        protected override void ItemSelectorLoad(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    comboBox1.DataSource = GameGlobals.Map.GameObjects.Where(item => item is IMenuBtn).ToList();
                    comboBox1.SelectedIndex = 0;
                }
                itemLabel.Text = "Menu Object:";
            }
        ...
        protected override void ComboBoxSelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox1.SelectedItem is PhysicalObject)
                MenuObjectName = ((PhysicalObject)comboBox1.SelectedItem).Name;
        }

        protected override void OnLoad(EventArgs e)
        {
            base.OnLoad(e);
            this.Name = "MenuObjectSelector";
            this.Text = "Menu Object Selector";
