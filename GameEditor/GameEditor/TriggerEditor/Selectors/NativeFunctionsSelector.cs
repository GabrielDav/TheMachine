...
{
    public class NativeParametersBoolSelector : ListSelector
    {
        ...
        protected override void ItemSelectorLoad(object sender, EventArgs e)
        {
            var binding = new BindingSource {
                DataSource = Enum.GetValues(typeof(NativeParameterBool)).Cast<NativeParameterBool>().ToDictionary(key => (int)key,
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Name = "NativeFunctionsSelector";
            Text = "Native Functions Selector";
            ResumeLayout(false);
            PerformLayout();
        }
