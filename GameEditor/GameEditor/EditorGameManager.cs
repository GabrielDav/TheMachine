...
{
    public interface IEditorGameEmulator : IDisposable
    {
        void SetState(bool paused);
        void Draw();
        void InputOnPress(Point p, int id);
    }

    public class EditorGameManager : GameManager, IDisposable, IEditorGameEmulator
    {
        ...
        public EditorGameManager(Map map)
        {
        ...
        {
            if (GameGlobals.GameOver && GameGlobals.LevelComplete)
            {
