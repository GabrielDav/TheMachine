...
namespace Engine.Graphics
{
    ...
    public class PrimitiveBatch : IDisposable
    {
        ...
        // positionInBuffer.
        protected readonly VertexPositionColor[] _vertices = new VertexPositionColor[DefaultBufferSize];
        ...
        // called.
        protected int _positionInBuffer;

        // a basic effect, which contains the shaders that we will use to draw our
        // primitives.
        protected readonly BasicEffect _basicEffect;
        ...
        protected int _numVertsPerPrimitive;

        // hasBegun is flipped to true once Begin is called, and is used to make
        // sure users don't call End before Begin is called.
        protected bool _hasBegun;
        ...
        public void Begin(PrimitiveType primitiveType, Matrix viewMatrix)
        {
            if (_hasBegun)
            {
        ...
        private void Flush()
        {
            ...
            _device.DrawUserPrimitives(_primitiveType, _vertices, 0,
                primitiveCount);
        ...
        {
            AddVertex(new Vector2(x1, y1), color);
            AddVertex(new Vector2(x2, y2), color);
        }
